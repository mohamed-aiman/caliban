...
<aside class="w-64" aria-label="Sidebar">
   <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
      <ul class="space-y-2">
         ...
         <li>
            <router-link to="/dashboard/listings" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                    class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                >
               ...
               <span class="flex-1 ml-3 whitespace-nowrap">My Listing</span>
            </router-link>
         </li>
         <li>
            <router-link to="/"
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Delivery Methods</span>
                <span
        ...
        <li>
            <router-link to="/test"
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Payment Methods</span>
                <span
                    class="inline-flex justify-center items-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
            </router-link>
        </li>
        <li>
            <router-link to="/test"
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Seller Profile</span>
                <span
                    class="inline-flex justify-center items-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
            </router-link>
        </li>
        <li>
            <router-link to="/dashboard/watchlist"
                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">My Watch List</span> 
            </router-link>
        </li>
        <li>
            <router-link to="/test"
