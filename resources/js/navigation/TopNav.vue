    ...
    <nav class="relative flex flex-wrap items-center justify-between px-2 py-3 bg-teal-500 mb-3">
        <div class="container px-2 mx-auto flex flex-wrap items-center justify-between">
            <div class="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
                ...
                <a class="hidden sm:block mx-6 text-sm font-bold leading-relaxed mr-4 py-2 whitespace-nowrap uppercase text-white"
                    href="/">
                ...
                <div class="hidden sm:block">
                    <ul class="flex flex-nowrap items-center justify-center list-none ml-auto">
                        <li class="nav-item">
