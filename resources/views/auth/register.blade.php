                ...
                <form class="mt-4 space-y-6 sm:mt-6" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="terms" class="font-light text-gray-500 dark:text-gray-300">By signing up,
                                    you are creating a {{ config('app.name') }} account, and you agree to {{ config('app.name') }}’s <a
                        ...
                        {{-- <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                <label for="newsletter" class="font-light text-gray-500 dark:text-gray-300">Email me
