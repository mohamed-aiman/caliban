...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100">
            ...
            <div class="flex items-center justify-end px-4 py-3 bg-white border-b border-gray-200">
                        ...
                        <div class="p-6 bg-white border-b border-gray-200"> --}}
                            ...
                            <div id="app" class="grid grid-cols-12 mx-auto w-full px-10 py-10" v-cloak>
                                <div class="col-span-2">
                                    ...
                                    <p><a href="{{ route('listings.create') }}" class="font-bold text-blue-800">Add Listing</a></p>
