    ...
    <body id="app" class="antialiased">
        ...
        {{-- top navigation with search bar --}}
            <div class="flex bg-teal-600 justify-between items-baseline">
                <a href="{{ route('home') }}" class="mx-6 text-white font-bold text-2xl">Home</a>
                {{-- search bar start --}}
                    ...
                    <form method="GET" action={{ route('home') }}>
                        ...
                        <div class="relative">
                            ...
                            <input type="search" 
                                ...
                                >
                            <div class="flex space-x-2 text-white absolute right-2.5 bottom-2.5">
                                {{-- <svg aria-hidden="true" class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg> --}}
                ...
                <div>
                    @auth
                        <a href="{{ route('dashboard') }}" class="mx-6 text-white font-bold text-2xl">
                            {{ auth()->user()->username }}
                        </a>
                    @endauth
                </div>
